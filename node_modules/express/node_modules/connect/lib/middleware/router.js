...
console.log("Express::router# Normalizing path: " + path);
console.log("Express::router# With keys: " + keys);
  path = path
    .concat('/?')
    .replace(/\/\(/g, '(?:/')
...
console.log("Express::match# Request: " + req);
console.log("Express::match# Routes: " + routes);
console.log("Express::match# i: " + i);
  var captures
    , method = req.method
    , i = i || 0;
